...
public class CBSceneFPBoomBoxClose : AbstractCBScene
{
    private Done d;
    ...
    private void createInspectButton()
    {
        ...
        if (!(Inspection.getBoomBox()))
            c.createButtons("buttonInspect", c.getCanvas().GetComponent<Canvas>().transform, dicAnchor, new UnityAction(delegate { lis_inspect(); }),
             false, true);
