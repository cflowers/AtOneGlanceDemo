...
public class CBSceneFPMessPaper1 : AbstractCBScene
{
    private Done d;
    ...
    private void createPaper1Button()
    {
        ...
        c.createButtons("buttonPaper1", c.getCanvas().GetComponent<Canvas>().transform, dicAnchor, new UnityAction(delegate { lis_paper1(); }),
          false, true);
