...
public class CBSceneCouchBook : AbstractCBScene
{
    private Done d;
    ...
    private void createCouchBookButton()
    {
        ...
        c.createButtons("buttonCouchBook", c.getCanvas().GetComponent<Canvas>().transform, dicAnchor, new UnityAction(delegate { lis_couchBook(); }),
          false, true);
